...
var _a = require("validator"), isEmail = _a.isEmail, isAlphanumeric = _a.isAlphanumeric, isLength = _a.isLength;
...
var checkDuplicateUsername = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userService.getUserIdByUsername(username)];
            case 2:
                user = _a.sent();
                if (user) {
...
var checkDuplicateEmail = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userService.getUserIdByEmail(email)];
            case 2:
                user = _a.sent();
                if (user) {
