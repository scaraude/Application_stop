...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.app = void 0;\n/* eslint-disable no-undef */\nvar express_1 = __importDefault(__webpack_require__(/*! express */ \"express\"));\nvar morgan_1 = __importDefault(__webpack_require__(/*! morgan */ \"morgan\"));\nvar errorhandler_1 = __importDefault(__webpack_require__(/*! errorhandler */ \"errorhandler\"));\nvar path_1 = __importDefault(__webpack_require__(/*! path */ \"path\"));\nvar cors_1 = __importDefault(__webpack_require__(/*! cors */ \"cors\"));\nvar logger_1 = __webpack_require__(/*! ./utils/logger */ \"./src/utils/logger.ts\");\nvar database_service_1 = __webpack_require__(/*! ./database/database.service */ \"./src/database/database.service.ts\");\nvar auth_routes_1 = __webpack_require__(/*! ./auth/auth.routes */ \"./src/auth/auth.routes.ts\");\nvar user_routes_1 = __webpack_require__(/*! ./user/user.routes */ \"./src/user/user.routes.ts\");\nvar spot_route_1 = __webpack_require__(/*! ./spot/spot.route */ \"./src/spot/spot.route.ts\");\nvar comment_route_1 = __webpack_require__(/*! ./comment/comment.route */ \"./src/comment/comment.route.ts\");\nexports.app = (0, express_1.default)();\nif (true) {\n    exports.app.use((0, cors_1.default)());\n}\nexports.app.use(express_1.default.json());\nexports.app.use(express_1.default.urlencoded({ extended: true }));\nexports.app.use(express_1.default.static(\"public\"));\nexports.app.use((0, morgan_1.default)(\"dev\"));\ndatabase_service_1.databaseService.connectDB();\nexports.app.get(\"/\", function (req, res) {\n    res.sendFile(path_1.default.join(process.cwd(), \"public\", \"index.html\"));\n});\n(0, auth_routes_1.authRouter)(exports.app);\n(0, user_routes_1.userRouter)(exports.app);\n(0, spot_route_1.spotRouter)(exports.app);\n(0, comment_route_1.commentRouter)(exports.app);\nexports.app.get(\"/*\", function (req, res) {\n    res.sendFile(path_1.default.join(process.cwd(), \"public\", \"index.html\"));\n});\nif (true) {\n    exports.app.use((0, errorhandler_1.default)());\n}\nelse {}\n\n\n//# sourceURL=webpack:///./src/app.ts?");
