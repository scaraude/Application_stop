...
exports.createComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, rating, text, user, spot, comment, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                user = _b.sent();
                return [4 /*yield*/, Spot.findById(req.params.spotId)];
            case 3:
                spot = _b.sent();
                comment = new Comment({
                    rating: rating,
...
exports.modifyComment = function (req, res) {
    Comment.updateOne({ _id: req.params.id }, __assign({}, req.body))
        .then(function (info) {
...
exports.getAllCommentsOneSpot = function (req, res) {
