...
var createUser = function (username, email, password, roles) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                rolesNamesRelatedToUser = roles || ["user"];
                return [4 /*yield*/, Role.find({
                        name: { $in: rolesNamesRelatedToUser },
                    })];
            case 1:
                rolesRelatedToUser = _a.sent();
...
var getUserIdByUsername = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!username) {
                ...
                return [4 /*yield*/, User.findOne({ username: username }).populate("roles", "-__v")];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, User.findOne({ email: email }).populate("roles", "-__v")];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var deleteUserByEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, User.deleteOne({ email: email })];
    });
}); };
var userService = {
